...
const BG_PRESETS: Record<BgPreset, { gradient: string; label: string; emoji: string }> = {
  sky:      { gradient: 'linear-gradient(160deg, #87CEEB 0%, #98FB98 100%)', label: '☀️ Sunny Sky', emoji: '☀️' },
  sunset:   { gradient: 'linear-gradient(160deg, #FF8C00 0%, #FF6B6B 100%)', label: '🌇 Sunset',    emoji: '🌅' },
  night:    { gradient: 'linear-gradient(160deg, #1a1a2e 0%, #16213E 100%)', label: '🌙 Night',     emoji: '🌙' },
  garden:   { gradient: 'linear-gradient(160deg, #4CAF50 0%, #8BC34A 100%)', label: '🌻 Garden',    emoji: '🌻' },
  indoors:  { gradient: 'linear-gradient(160deg, #FFD3A5 0%, #FFA07A 100%)', label: '🏠 Indoors',   emoji: '🏠' },
  party:    { gradient: 'linear-gradient(160deg, #9C27B0 0%, #E91E63 100%)', label: '🎉 Party',     emoji: '🎉' },
  beach:    { gradient: 'linear-gradient(160deg, #00CED1 0%, #FFD700 100%)', label: '🏖️ Beach',     emoji: '🏖️' },
};
